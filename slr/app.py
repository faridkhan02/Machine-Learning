...
st.title("Salary Prediction App created by MD FARID KHAN")
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by MD FARID KHAN")